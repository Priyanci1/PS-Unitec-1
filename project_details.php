...
<html>
<head>
	<title>PortFolio - Welcome Here</title>
	<meta charset="utf-8">
...
<section class="testimonial py-5" id="testimonial">
    <div class="container">
    	<form method="post" action="add_project_details.php" enctype="multipart/form-data">
	        <div class="row ">
		            ...
		            <div class="col-md-8 py-5 border">
		            	<?php  
		            		if (isset($_SESSION['p_fail']))
		            		{
		            			
		            	?>
		            	<div class="alert alert-danger" role="alert">
  							<?php echo $_SESSION['p_fail']; ?>
						</div>
						<?php 
							unset($_SESSION['p_fail']);
						}
						?>
		                <h1 class="pb-4 text-warning">Project Details</h1>
		                    ...
		                    <a href="achievement_details.php" class="text-primary">Click here to move next</a> <br><br>
		                    <div class="form-row">	
		                    ...
		                    <div class="form-row">
			                        <div class="form-group col-md-12">
			                        	<input type="text" name="pro_name" placeholder="Project title" class="form-control" required="">
			                        </div>
		                    ...
		                    <div class="form-row">
			                        <div class="form-group col-md-12">
			                        	<input type="text" name="pro_dur" placeholder="Project duration" class="form-control" required="">
			                        </div>
			                        <div class="col-md-12 form-group">
			                        	<textarea name="pro_desc" placeholder="Project Description" class="form-control"></textarea>
									</div>
		                    </div>
